...
// Is the game currently playing?
    ...
    public void draw() {
        ...
        if (surfaceHolder.getSurface().isValid()) {
            ...
            canvas.drawColor(Color.argb(255, 20, 30, 150));
            ...
            canvas.drawText("Level: 1", 120, 70, paint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
     ...
     public void openSnakeActivity2(){
     Intent intent = new Intent(getContext(), SnakeActivity2.class);
