...
class SnakeEngine2 extends SurfaceView implements Runnable {
...
// Is the game currently playing?
    ...
    public SnakeEngine2(Context context, Point size) {
        super(context);
    ...
    public void spawnBob2() {
        Random random1 = new Random();
        bob1X = random1.nextInt(numBlocksWide - 5) + 1;
        bob1Y = random1.nextInt(numBlocksHigh - 5) + 1;
    }
    ...
    private void moveSnake() {
        ...
        if (snakeXs[0] < 0) snakeXs[0] += numBlocksWide;
        snakeXs[0] %= numBlocksWide;
        if (snakeYs[0] < 0) snakeYs[0] += numBlocksHigh;
    ...
    public void update() {
        ...
        if (snakeXs[0] == bob1X && snakeYs[0] == bob1Y) {
            newGame();
        }
        moveSnake();
    ...
    public void draw() {
        ...
        if (surfaceHolder.getSurface().isValid()) {
            ...
            canvas.drawColor(Color.argb(255, 100, 180, 70));
            ...
            canvas.drawText("Level: 2", 120, 70, paint);
            ...
            canvas.drawRect(bob1X * blockSize,
                    (bob1Y * blockSize),
                    (bob1X * blockSize) + blockSize,
                    (bob1Y * blockSize) + blockSize,
                    paint);
    ...
    public void openSnakeActivity3(){
       Intent intent = new Intent(getContext(), SnakeActivity3.class);
