...
class SnakeEngine3 extends SurfaceView implements Runnable {
...
// Is the game currently playing?
    ...
    public SnakeEngine3(Context context, Point size) {
        super(context);
    ...
    public void draw() {
        ...
        if (surfaceHolder.getSurface().isValid()) {
            ...
            // Fill the backgound green
            canvas.drawColor(Color.argb(255, 90, 180, 70));
            ...
            canvas.drawText("Level: 3", 120, 70, paint);
